...
from custom_wrapper_diff_f3 import StreetFighterCustomWrapper
...
def main(args):
    ...
    # env = DummyVecEnv([make_env(game, state=args.state, rd_type=args.rd_type, reset_round=args.reset_round)])
